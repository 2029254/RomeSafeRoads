...
Discover the live version of our project:<br>
 - running the server file ```/app.py```<br>
 - reaching the ```http://localhost:63342/visual-analytics/index.html``` through your browser.<br>
