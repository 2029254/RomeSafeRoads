...
dataset = pd.read_csv('dataset/source/accidents-2020/01-Gennaio.csv', sep=';', encoding='latin-1')
...
incidenti_per_data.to_csv('dataset/processed/timeSeries/2020/timeSeriesNatureC2.csv', header=True, index=False)
