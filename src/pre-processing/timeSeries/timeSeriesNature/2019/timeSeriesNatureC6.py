...
dataset_rows = dataset_columns.loc[dataset_columns['NaturaIncidente'].isin(['Infortunio per sola frenata improvvisa', 'Infortunio per caduta del veicolo'])]
...
result_df.to_csv('dataset/processed/timeSeries/2019/timeSeriesNatureC6.csv', header=True, index=False)
