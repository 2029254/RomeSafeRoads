...
date_range = pd.date_range(start='2019-01-01', end='2019-12-31', freq='1D')

# Iterare sugli intervalli di 10 giorni
for start_date in date_range:
    end_date = start_date + pd.Timedelta(days=1)  # Calcola la data di fine intervallo
...
result_df.to_csv('dataset/processed/timeSeries/timeSeriesData2019Daily.csv', header=True, index=False)