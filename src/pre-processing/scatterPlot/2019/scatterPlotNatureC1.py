...
dataset = pd.read_csv('dataset/processed/scatterPlot/Data/scatterPlotNatureC1-2019.csv')
...
df_components.to_csv('dataset/processed/scatterPlot/2019/scatterPlotNatureC1.csv', index=False)