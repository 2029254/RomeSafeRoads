...
dataset = pd.read_csv('dataset/processed/scatterPlot/Data/scatterPlotNatureC3-2019.csv')
...
df_components.to_csv('dataset/processed/scatterPlot/2019/scatterPlotNatureC3.csv', index=False)