...
dataset = pd.read_csv('dataset/processed/scatterPlot/Data/scatterPlotNatureC4-2019.csv')
...
df_components.to_csv('dataset/processed/scatterPlot/2019/scatterPlotNatureC4.csv', index=False)