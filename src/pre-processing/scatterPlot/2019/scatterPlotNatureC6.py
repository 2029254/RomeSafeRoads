...
dataset = pd.read_csv('dataset/processed/scatterPlot/Data/scatterPlotNatureC6-2019.csv')
...
df_components.to_csv('dataset/processed/scatterPlot/2019/scatterPlotNatureC6.csv', index=False)