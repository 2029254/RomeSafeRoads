...
dataset = pd.read_csv('dataset/processed/scatterPlot/Data/scatterPlotNatureC7-2019.csv')
...
df_components.to_csv('dataset/processed/scatterPlot/2019/scatterPlotNatureC7.csv', index=False)