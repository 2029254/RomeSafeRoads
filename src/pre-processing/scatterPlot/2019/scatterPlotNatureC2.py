...
dataset = pd.read_csv('dataset/processed/scatterPlot/Data/scatterPlotNatureC2-2019.csv')
...
df_components.to_csv('dataset/processed/scatterPlot/2019/scatterPlotNatureC2.csv', index=False)