...
dataset_columns = dataset_columns.loc[dataset_columns['NaturaIncidente'].isin(['Infortunio per sola frenata improvvisa', 'Infortunio per caduta del veicolo'])]
...
accidents_data_frame.to_csv('dataset/processed/scatterPlot/Data/scatterPlotNatureC6-2021.csv', header=True)