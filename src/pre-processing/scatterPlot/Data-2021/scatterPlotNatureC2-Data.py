...
dataset_columns = dataset_columns[dataset_columns['NaturaIncidente'].isin(['Scontro frontale fra veicoli in marcia', 'Scontro laterale fra veicoli in marcia'])]
...
accidents_data_frame.to_csv('dataset/processed/scatterPlot/Data/scatterPlotNatureC2-2021.csv', header=True)