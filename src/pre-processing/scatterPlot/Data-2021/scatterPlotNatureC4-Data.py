...
dataset_columns = dataset_columns.loc[dataset_columns['NaturaIncidente'].isin(['Tamponamento', 'Tamponamento Multiplo'])]
...
accidents_data_frame.to_csv('dataset/processed/scatterPlot/Data/scatterPlotNatureC4-2021.csv', header=True)