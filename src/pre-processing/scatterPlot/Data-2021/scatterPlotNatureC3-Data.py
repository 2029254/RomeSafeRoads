...
dataset_columns = dataset_columns.loc[dataset_columns['NaturaIncidente'].isin(['Veicolo in marcia contro veicolo in sosta', 'Veicolo in marcia contro veicolo fermo', 'Veicolo in marcia contro veicolo arresto'])]
...
accidents_data_frame.to_csv('dataset/processed/scatterPlot/Data/scatterPlotNatureC3-2021.csv', header=True)