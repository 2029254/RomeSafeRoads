...
dataset_columns = dataset_columns[dataset_columns['NaturaIncidente'] == 'Investimento di pedone']
...
accidents_data_frame.to_csv('dataset/processed/scatterPlot/Data/scatterPlotNatureC1-2021.csv', header=True)