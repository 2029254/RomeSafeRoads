...
dataset = pd.read_csv('dataset/processed/scatterPlot/Data/scatterPlotNatureC8-2021.csv')
...
df_components.to_csv('dataset/processed/scatterPlot/2021/scatterPlotNatureC8.csv', index=False)