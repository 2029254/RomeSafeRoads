...
dataset = pd.read_csv('dataset/processed/scatterPlot/Data/scatterPlotNatureC1-2021.csv')
...
df_components.to_csv('dataset/processed/scatterPlot/2021/scatterPlotNatureC1.csv', index=False)