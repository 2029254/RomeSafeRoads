...
dataset = pd.read_csv('dataset/processed/scatterPlot/Data/scatterPlotNatureC2-2020.csv')
...
df_components.to_csv('dataset/processed/scatterPlot/2020/scatterPlotNatureC2.csv', index=False)