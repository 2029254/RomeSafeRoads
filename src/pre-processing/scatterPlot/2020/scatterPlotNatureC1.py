...
dataset = pd.read_csv('dataset/processed/scatterPlot/Data/scatterPlotNatureC1-2020.csv')
...
df_components.to_csv('dataset/processed/scatterPlot/2020/scatterPlotNatureC1.csv', index=False)