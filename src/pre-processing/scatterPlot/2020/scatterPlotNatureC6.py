...
dataset = pd.read_csv('dataset/processed/scatterPlot/Data/scatterPlotNatureC6-2020.csv')
...
df_components.to_csv('dataset/processed/scatterPlot/2020/scatterPlotNatureC6.csv', index=False)