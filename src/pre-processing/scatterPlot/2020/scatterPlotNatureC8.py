...
dataset = pd.read_csv('dataset/processed/scatterPlot/Data/scatterPlotNatureC8-2020.csv')
...
df_components.to_csv('dataset/processed/scatterPlot/2020/scatterPlotNatureC8.csv', index=False)