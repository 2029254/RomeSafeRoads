...
dataset = pd.read_csv('dataset/processed/scatterPlot/Data/scatterPlotNatureC3-2020.csv')
...
df_components.to_csv('dataset/processed/scatterPlot/2020/scatterPlotNatureC3.csv', index=False)