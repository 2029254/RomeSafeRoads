...
dataset = pd.read_csv('dataset/processed/scatterPlot/Data/scatterPlotNatureC7-2020.csv')
...
df_components.to_csv('dataset/processed/scatterPlot/2020/scatterPlotNatureC7.csv', index=False)