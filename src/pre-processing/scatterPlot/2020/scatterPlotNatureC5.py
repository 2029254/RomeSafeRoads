...
dataset = pd.read_csv('dataset/processed/scatterPlot/Data/scatterPlotNatureC5-2020.csv')
...
df_components.to_csv('dataset/processed/scatterPlot/2020/scatterPlotNatureC5.csv', index=False)