...
dataset = pd.read_csv('dataset/processed/scatterPlot/Data/scatterPlotNatureC4-2020.csv')
...
df_components.to_csv('dataset/processed/scatterPlot/2020/scatterPlotNatureC4.csv', index=False)