...
dataset = pd.read_csv('dataset/processed/scatterPlot/Data/scatterPlotNatureC1-2022.csv')
...
df_components.to_csv('dataset/processed/scatterPlot/2022/scatterPlotNatureC1.csv', index=False)