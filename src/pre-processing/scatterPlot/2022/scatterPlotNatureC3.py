...
dataset = pd.read_csv('dataset/processed/scatterPlot/Data/scatterPlotNatureC3-2022.csv')
...
df_components.to_csv('dataset/processed/scatterPlot/2022/scatterPlotNatureC3.csv', index=False)